...
export enum I18nKey {
  ...
  SETTINGS$SKILLS_TRIGGERS_LABEL = "SETTINGS$SKILLS_TRIGGERS_LABEL",
  SETTINGS$SKILLS_EMPTY_HINT = "SETTINGS$SKILLS_EMPTY_HINT",
  SETTINGS$SKILLS_PUBLIC_SECTION = "SETTINGS$SKILLS_PUBLIC_SECTION",
  SETTINGS$SKILLS_USER_SECTION = "SETTINGS$SKILLS_USER_SECTION",
  SETTINGS$SKILLS_ORG_SECTION = "SETTINGS$SKILLS_ORG_SECTION",
  SETTINGS$SKILLS_ALL_SECTION = "SETTINGS$SKILLS_ALL_SECTION",
